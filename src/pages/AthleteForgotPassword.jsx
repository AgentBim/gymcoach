...
export default function AthleteForgotPassword() {
    ...
    <div style={{ minHeight: '100vh', display: 'flex', alignItems: 'center', justifyContent: 'center', background: 'var(--bg)' }}>
      <div style={{ width: 340 }}>
        <div style={{ textAlign: 'center', marginBottom: 32 }}>
          ...
          <p style={{ fontSize: 13, color: 'var(--mu)' }}>Reset your portal password</p>
        </div>
        ...
        <div style={{ background: 'var(--s1)', border: '1px solid var(--br)', borderRadius: 14, padding: 24 }}>
          ...
          <p style={{ fontSize: 11, color: 'var(--mu)', textAlign: 'center', marginTop: 16 }}>
            <Link to="/athlete/login" style={{ color: 'var(--mu)' }}>← Back to log in</Link>
          </p>
        </div>
      </div>
    </div>
